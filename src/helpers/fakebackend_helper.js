...
// GET DASHBOARD / RECEIPT DATA
export const getReceiptDataApi = () => api.get(url.GET_RECEIPT_DATA);

export const updateReceiptStatusApi = (data) =>
  api.create(url.UPDATE_RECEIPT_STATUS, data);
/******************************** APP API'S FUNCTIONS ***********************************/
