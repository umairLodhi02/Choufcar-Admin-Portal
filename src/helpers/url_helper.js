...
//LOGIN
export const POST_LOGIN = "/manageSpecificUser/createOrLoginUser";

// DASHBOARD RECEIPT
export const GET_RECEIPT_DATA = "/receipt/getAllReceipts";
export const UPDATE_RECEIPT_STATUS = "/receipt/updateReceiptStatus";
